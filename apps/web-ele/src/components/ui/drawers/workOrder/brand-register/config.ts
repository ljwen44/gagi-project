...
export enum BrandRegisterTabEnum {
...
export const drawerFormItems: IFormItem[] = [
  ...
  { label: '协议编号', prop: 'agreementNo', class: 'col-span-3' },
  { label: '国家', prop: 'country' },
  { label: '产品名称', prop: 'productName' },
  { label: '所属人', prop: 'username', class: 'col-span-2' },
...
export const brandRegisterTabs = [
  { label: '工单详情', key: BrandRegisterTabEnum.detail },
  { label: '工单确认书', key: BrandRegisterTabEnum.confirm },
  { label: '工单附件', key: BrandRegisterTabEnum.attachment },
  { label: '关联协议', key: BrandRegisterTabEnum.protocol },
  { label: '关联异常单', key: BrandRegisterTabEnum.abnormalOrder },
  { label: '跟进记录', key: BrandRegisterTabEnum.followRecord },
  { label: '共享人员', key: BrandRegisterTabEnum.share },
  { label: '操作记录', key: BrandRegisterTabEnum.operatorRecord },
];

export const componentsMap: Record<any, IComponent> = {
  [BrandRegisterTabEnum.followRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/FollowUpRecord.vue'),
    ),
  },
  [BrandRegisterTabEnum.share]: {
    component: defineAsyncComponent(
      () => import('../../common/SharePerson.vue'),
    ),
  },
  [BrandRegisterTabEnum.operatorRecord]: {
    component: defineAsyncComponent(
  ...
  [BrandRegisterTabEnum.detail]: {
    component: defineAsyncComponent(
      () => import('../../common/WorkOrderDetail.vue'),
    ),
  },
  [BrandRegisterTabEnum.confirm]: {
    component: defineAsyncComponent(
      () => import('./components/OrderConfirm.vue'),
    ),
  },
  [BrandRegisterTabEnum.attachment]: {
    component: defineAsyncComponent(
  ...
  [BrandRegisterTabEnum.protocol]: {
    component: defineAsyncComponent(
      () => import('../../common/ProtocolTable.vue'),
    ),
  },
  [BrandRegisterTabEnum.abnormalOrder]: {
    component: defineAsyncComponent(
...
export const detailFormItems: IFormItem[] = [
  ...
  { label: '商标类型', prop: 'brandType' },
  { label: '商标文字', prop: 'brandText' },
  { label: '商标大类', prop: 'brandBItem', class: 'col-span-2' },
  { label: '商标小类', prop: 'brandSItem', class: 'col-span-2' },
  { label: '最早使用时间', prop: 'time', class: 'col-span-2' },
