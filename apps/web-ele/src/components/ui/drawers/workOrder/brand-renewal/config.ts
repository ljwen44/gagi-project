...
export enum BrandRenewalTabEnum {
...
export const brandRenewalTabs = [
  { label: '工单详情', key: BrandRenewalTabEnum.detail },
  { label: '工单确认书', key: BrandRenewalTabEnum.confirm },
  { label: '工单附件', key: BrandRenewalTabEnum.attachment },
  { label: '关联协议', key: BrandRenewalTabEnum.protocol },
  { label: '跟进记录', key: BrandRenewalTabEnum.followRecord },
  { label: '共享人员', key: BrandRenewalTabEnum.share },
  { label: '操作记录', key: BrandRenewalTabEnum.operatorRecord },
];

export const componentsMap: Record<any, IComponent> = {
  [BrandRenewalTabEnum.followRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/FollowUpRecord.vue'),
    ),
  },
  [BrandRenewalTabEnum.share]: {
    component: defineAsyncComponent(
      () => import('../../common/SharePerson.vue'),
    ),
  },
  [BrandRenewalTabEnum.operatorRecord]: {
    component: defineAsyncComponent(
  ...
  [BrandRenewalTabEnum.attachment]: {
    component: defineAsyncComponent(
