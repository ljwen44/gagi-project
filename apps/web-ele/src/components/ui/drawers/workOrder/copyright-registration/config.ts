...
export const copyrightRegistrationTabs = [
  { label: '工单详情', key: CopyrightRegistrationTabEnum.detail },
  { label: '工单确认书', key: CopyrightRegistrationTabEnum.confirm },
  { label: '工单附件', key: CopyrightRegistrationTabEnum.attachment },
  { label: '关联协议', key: CopyrightRegistrationTabEnum.protocol },
  { label: '关联异常单', key: CopyrightRegistrationTabEnum.abnormalOrder },
  { label: '跟进记录', key: CopyrightRegistrationTabEnum.followRecord },
  { label: '共享人员', key: CopyrightRegistrationTabEnum.share },
  { label: '操作记录', key: CopyrightRegistrationTabEnum.operatorRecord },
];

export const componentsMap: Record<any, IComponent> = {
  [CopyrightRegistrationTabEnum.followRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/FollowUpRecord.vue'),
    ),
  },
  [CopyrightRegistrationTabEnum.share]: {
    component: defineAsyncComponent(
      () => import('../../common/SharePerson.vue'),
    ),
  },
  [CopyrightRegistrationTabEnum.operatorRecord]: {
    component: defineAsyncComponent(
  ...
  [CopyrightRegistrationTabEnum.abnormalOrder]: {
    component: defineAsyncComponent(
...
export const detailFormItems: IFormItem[] = [
  ...
  { label: '创作完成时间', prop: 'productPublic' },
  { label: '公开时间', prop: 'otherCountryApply' },
