...
export enum SpecialServiceTabEnum {
...
export const specialSerivceTabs = [
  { label: '工单详情', key: SpecialServiceTabEnum.detail },
  { label: '工单确认书', key: SpecialServiceTabEnum.confirm },
  { label: '工单附件', key: SpecialServiceTabEnum.attachment },
  { label: '关联协议', key: SpecialServiceTabEnum.protocol },
  { label: '跟进记录', key: SpecialServiceTabEnum.followRecord },
  { label: '共享人员', key: SpecialServiceTabEnum.share },
  { label: '操作记录', key: SpecialServiceTabEnum.operatorRecord },
];

export const componentsMap: Record<any, IComponent> = {
  [SpecialServiceTabEnum.followRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/FollowUpRecord.vue'),
    ),
  },
  [SpecialServiceTabEnum.share]: {
    component: defineAsyncComponent(
      () => import('../../common/SharePerson.vue'),
    ),
  },
  [SpecialServiceTabEnum.operatorRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/OperatorRecord.vue'),
    ),
  },
  [SpecialServiceTabEnum.detail]: {
    component: defineAsyncComponent(
      () => import('../../common/WorkOrderDetail.vue'),
    ),
  },
  [SpecialServiceTabEnum.confirm]: {
    component: defineAsyncComponent(
      () => import('./components/OrderConfirm.vue'),
    ),
  },
  [SpecialServiceTabEnum.attachment]: {
    component: defineAsyncComponent(
  ...
  [SpecialServiceTabEnum.protocol]: {
    component: defineAsyncComponent(
