...
export enum BrandObjectionTabEnum {
...
export const drawerFormItems: IFormItem[] = [
  ...
  { label: '工单状态', prop: 'workStatus', class: 'col-span-2' },
...
export const brandObjectionTabs = [
  { label: '工单详情', key: BrandObjectionTabEnum.detail },
  { label: '工单确认书', key: BrandObjectionTabEnum.confirm },
  { label: '工单附件', key: BrandObjectionTabEnum.attachment },
  { label: '关联协议', key: BrandObjectionTabEnum.protocol },
  { label: '跟进记录', key: BrandObjectionTabEnum.followRecord },
  { label: '共享人员', key: BrandObjectionTabEnum.share },
  { label: '操作记录', key: BrandObjectionTabEnum.operatorRecord },
];

export const componentsMap: Record<any, IComponent> = {
  [BrandObjectionTabEnum.followRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/FollowUpRecord.vue'),
    ),
  },
  [BrandObjectionTabEnum.share]: {
    component: defineAsyncComponent(
      () => import('../../common/SharePerson.vue'),
    ),
  },
  [BrandObjectionTabEnum.operatorRecord]: {
    component: defineAsyncComponent(
      () => import('../../common/OperatorRecord.vue'),
    ),
  },
  [BrandObjectionTabEnum.detail]: {
    component: defineAsyncComponent(
      () => import('../../common/WorkOrderDetail.vue'),
    ),
  },
  [BrandObjectionTabEnum.confirm]: {
    component: defineAsyncComponent(
      () => import('./components/OrderConfirm.vue'),
    ),
  },
  [BrandObjectionTabEnum.attachment]: {
    component: defineAsyncComponent(
  ...
  [BrandObjectionTabEnum.protocol]: {
    component: defineAsyncComponent(
