...
export const orderRecordColumns: ITableColumnProps[] = [
  ...
  { label: '客户公司名称', prop: 'custTitle', sortable: true },
...
export const workOrderRecordColumns: ITableColumnProps[] = [
  { label: '编号', type: 'index', fixed: 'left', width: 60 },
  { label: '工单编号', prop: 'orderNo', sortable: true },
  ...
  { label: '接单状态', prop: 'receiveStatus', sortable: true },
  { label: '做单状态', prop: 'workStatus', sortable: true },
