...
import { getInfoApproved, Type } from '#/api/core/administration';
import { getAgreementApproved } from '#/api/core/protocol';
import { getWorkOrderApproved } from '#/api/core/workOrder';
...
export const apiMap: Record<string, any> = {
  [typeMap.protocol]: getAgreementApproved,
  [typeMap.workOrder]: getWorkOrderApproved,
  [typeMap.invoice]: (args: any) => getInfoApproved(Type.invoiceManage, args),
  [typeMap.reimbursement]: (args: any) =>
    getInfoApproved(Type.reimbursement, args),
  [typeMap.leaveApply]: (args: any) => getInfoApproved(Type.leaveApply, args),
  [typeMap.payment]: (args: any) => getInfoApproved(Type.paymentApply, args),
  [typeMap.refund]: (args: any) => getInfoApproved(Type.refundApply, args),
};
