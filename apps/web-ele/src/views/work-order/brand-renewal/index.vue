...
import BrandRenewalDrawer from '#/components/ui/drawers/workOrder/brand-renewal/brandRenewalDrawer.vue';
...
<template>
  ...
  >
    <template #number="{ row }">
      <el-link type="primary" @click="modalType = MODAL_TYPE.BRANDRENEWAL">
        {{ row.number }}
      </el-link>
    </template>
    ...
    <BrandRenewalDrawer
      :show="modalType === MODAL_TYPE.BRANDRENEWAL"
